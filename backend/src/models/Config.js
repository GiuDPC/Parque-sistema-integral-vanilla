 ...
 * ============================================
 * 
 * Este modelo maneja toda la configuración del sistema BRINCAPARK:
...
const configSchema = new mongoose.Schema(
  {
    ...
    isSingleton: {
      type: Boolean,
      default: true,
      unique: true, // ¡Esto es clave! Solo un documento puede tener isSingleton: true
    },
  },
  {
    // Mongoose agregará automáticamente createdAt y updatedAt
    timestamps: true,
  }
);
